...
const CategorySummary = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl p-4 sm:p-6 mx-auto flex flex-col">
      {/* Title */}
